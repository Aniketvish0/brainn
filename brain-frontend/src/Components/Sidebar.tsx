...
const Sidebar = () => {
  ...
  return (
    <motion.div 
      ...
      className={`relative flex flex-col h-full border-r whitespace-nowrap dark:border-neutral-800 border-gray-200 shadow-sm overflow-hidden`}
    >
      <div className="px-4 py-5 flex items-center sticky justify-between">
        {isSidebarOpen && (
          <motion.h2 variants={itemVariants} className="font-medium text-xl text-gray-700 dark:text-white ">
            Brainn Nodes
          </motion.h2>
        )}
        <PanelLeftClose 
      ...
      <div className="flex flex-col h-full overflow-y-auto">
        ...
        <div className="px-3 flex-shrink-0">
          {isSidebarOpen && <motion.div variants={itemVariants}><Separator text="WORKSPACE" className="mb-3 opacity-80" /></motion.div>}
