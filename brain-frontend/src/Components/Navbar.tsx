...
const Navbar = () => {
  return (
    <header className="bg-transparent backdrop-filter backdrop-blur-md dark:bg-slate-950 flex justify-around items-center dark:text-white text-neutral-950 min-h-20">
